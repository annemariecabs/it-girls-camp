/*
AnneMarie Caballero
This is a sample class that tests String methods
*/
...
public class StringMethods {
   ...
   String s = "Hello it's me, I was wondering";
   String s2 = "Now you're just somebody I used to know";
